        ...
        <div className="p-6 max-w-[1400px] mx-auto font-sans text-slate-800">
            ...
            <div className="sa-group-wrapper min-h-screen py-10">
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="sa-container max-w-5xl mx-auto px-6 space-y-16"
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-12 py-8">
                        ...
                        <div className="flex-1 text-center md:text-left space-y-6">
                            <div className="space-y-1">
                                <h2 className="text-3xl font-normal text-slate-900">{adminData.name}</h2>
                            ...
                            <div className="flex flex-wrap justify-center md:justify-start gap-4">
                                <button className="px-6 py-3 bg-orange-gradient text-white rounded-2xl font-medium text-sm transition-all hover:shadow-lg hover:shadow-orange-200 active:scale-95 flex items-center gap-2">
                                ...
                                <button className="px-6 py-3 bg-white text-red-500 border border-red-100 rounded-2xl font-medium text-sm transition-all hover:bg-red-50 active:scale-95 flex items-center gap-2">
                        ...
                        <div className="space-y-16">
                            <section className="space-y-8">
                                ...
                                <div className="space-y-8">
                                    <p className="text-slate-600 text-base leading-relaxed font-normal italic border-l-2 border-orange-200 pl-6 py-2">
                                        "{adminData.bio}"
                                    </p>
                                    <div className="grid gap-8">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-1">Email Address</p>
                                                <p className="text-slate-700 font-normal">{adminData.email}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-1">Direct Line</p>
                                                <p className="text-slate-700 font-normal">{adminData.phone}</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-[10px] font-medium text-slate-400 uppercase tracking-widest mb-1">Work Location</p>
                                                <p className="text-slate-700 font-normal">{adminData.location}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section className="space-y-10">
                                <div className="flex justify-between items-end">
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-lg text-slate-800 font-normal">Administrative Rights</p>
                                    </div>
                                ...
                                <div className="grid gap-6">
                                    {adminData.permissions.map((perm) => (
                                        <div
                                            key={perm.id}
                                            className="p-6 rounded-[2rem] bg-white border border-slate-100 hover:border-orange-200 transition-all flex gap-6 items-center group shadow-sm"
                                        >
                                            <div className="w-14 h-14 rounded-[1.25rem] bg-slate-50 flex items-center justify-center text-slate-400 group-hover:text-orange-500 transition-colors">
                                                {perm.icon}
                                            </div>
                                            <div className="space-y-1">
                                                <h4 className="text-sm font-medium text-slate-800">{perm.name}</h4>
                                                <p className="text-xs text-slate-500 font-normal leading-normal">{perm.description}</p>
                                            </div>
                                        </div>
                                    ))}
                                </div>
                                ...
                                <div className="bg-white rounded-[2.5rem] border border-slate-100 overflow-hidden shadow-sm">
                                    <div className="divide-y divide-slate-50">
                                        {adminData.recentActivity.map((act) => (
                                            <div key={act.id} className="p-8 flex items-center gap-6 hover:bg-slate-50/50 transition-colors">
                                                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 ${act.type === 'security' ? 'bg-red-50 text-red-500' :
                                                ...
                                                <div className="flex-1 space-y-1">
                                                    <p className="text-sm font-normal text-slate-800">{act.action}</p>
                                                    <div className="flex items-center gap-3 text-[10px] text-slate-400 font-medium uppercase tracking-widest">
                                    ...
                                    <button className="w-full py-6 text-xs font-medium text-slate-400 hover:text-orange-600 hover:bg-slate-50 transition-all border-t border-slate-50 uppercase tracking-widest">
