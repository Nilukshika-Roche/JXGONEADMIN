                    ...
                    >
                        <div className="bg-white rounded-xl shadow-xl w-full max-w-sm overflow-hidden" onClick={e => e.stopPropagation()}>
                            <div className="p-4 border-b flex justify-between items-center bg-red-50">
                                <h3 className="font-bold text-red-800 flex items-center gap-2"><AlertCircle size={18} /> Report Details</h3>
                                <button onClick={() => setReportedModalData({ isOpen: false, item: null, details: null })} className="text-red-400"><X size={20} /></button>
                            </div>
                            <div className="p-5 space-y-4">
                                ...
                                <div className="bg-slate-50 p-3 rounded-lg border">
                                    <p className="text-sm italic">"{reportedModalData.details.description}"</p>
                                </div>
                                <button onClick={() => setReportedModalData({ isOpen: false, item: null, details: null })} className="w-full py-2 bg-slate-100 rounded-lg font-semibold">Close</button>
                            </div>
                        </div>
                    </motion.div>
                )}
